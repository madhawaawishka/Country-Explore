      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-10 rounded-xl shadow-xl transition-all">
        <div>
          ...
          <p className="mt-3 text-center text-sm text-gray-600 dark:text-gray-400">
            Create your account to save favorite countries
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`appearance-none block w-full pl-10 px-3 py-3 border rounded-lg placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 sm:text-sm ${
                    confirmPassword ? 
                      passwordsMatch ? 
          ...
          <div>
            ...
            >
              <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                <UserPlus className="h-5 w-5 text-blue-400 group-hover:text-blue-300 transition-colors" />
              </span>
              {loading ? (
